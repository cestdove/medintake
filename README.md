...
The results provide initial evidence that biomedical-domain pretraining can be beneficial for this medical text classification task.

The complete experiment history, including training configurations, validation losses, classification reports, and confusion matrices, is available in [`experiments/benchmark.md`](experiments/benchmark.md).
...
The project uses a stratified validation split during model development while keeping the held-out test set for final evaluation.

Further work will focus on biomedical-domain models, Transformer error analysis, and newer architectures.
